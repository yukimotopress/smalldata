...
Example - [`leagues.txt`](https://github.com/sportkit/mu-mauritius/blob/master/leagues.txt):
...
Example - [`clubs.txt`](https://github.com/sportkit/mu-mauritius/blob/master/clubs.txt):
...
Example - [`2014-15/league-i.txt`](https://github.com/sportkit/mu-mauritius/blob/master/2014-15/league-i.txt):
...
Example - [`2014-15/league.yml`](https://github.com/sportkit/mu-mauritius/blob/master/2014-15/league.yml):
...
Example - [`setups/all.txt`](https://github.com/sportkit/mu-mauritius/blob/master/setups/all.txt):
...
Example - [`Datafile`](https://github.com/sportkit/mu-mauritius/blob/master/Datafile):
